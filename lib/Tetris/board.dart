...
import 'package:gaminghub/gameNavigationTetris.dart';
...
//current Score
  ...
  final Scores scoreDataTetris = Scores();
...
//Game over Dialog
  void showGameOverDialog() {
    scoreDataTetris.UpdateTetrisData(currentScore);
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text('Game Over'),
        content: Text("You scored: $currentScore"), ////Save into DB HERE 
        actions: [
          TextButton(
              onPressed: () {
                //reset the game
...
//commenting out the rotate button until fix
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        drawer: gameNavigationTetris(context: context, timer: gameTimer,),
        ...
        body: Stack(
          children: [
            NavigationTetris(scaffoldKey: scaffoldKey),
            Center(
                child: Container(
                    width: 398,
                    child: Column(
                      children: [
                        ...
                        /// If need be for the game menu    w397.3333333333333  h773.3333333333334
                        /// ******************************************************
                        ///
                        ///
                        /// 1265.3333333333333  682.6666666666666    w416.0  h796.0
                        Expanded(
